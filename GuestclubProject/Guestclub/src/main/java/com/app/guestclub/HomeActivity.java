...
public class HomeActivity extends Activity implements ActionBar.TabListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            System.out.println(Integer.parseInt(getArguments().get(ARG_SECTION_NUMBER).toString()));
            switch (Integer.parseInt(getArguments().get(ARG_SECTION_NUMBER).toString())) {
                case 1:
                    rootView = inflater.inflate(R.layout.personal_areal_fragment, container, false);
                    break;
                case 2:
